...
function createConfiguration() {
    return {
        ...
        sources: {
            'ProductFactory.sol': {
                content: fs.readFileSync(path.resolve(__dirname, 'contracts', 'ProductFactory.sol'), 'utf8')
            },/*
...
function getImports(dependency) {
    ...
    switch (dependency) {
        case 'Product.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, 'contracts', 'Product.sol'), 'utf8')};
